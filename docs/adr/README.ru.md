...
* [0016 — Cloud routing via froggy-mcp — data flow and privacy boundaries](0016-froggy-mcp-cloud-routing-privacy.ru.md)
* [0017 — Active/Paused toggle for the daemon](0017-active-mode-toggle.md)
* [0018 — Pageout без привилегий недостижим: `scratch` — единственная рабочая стратегия](0018-pageout-unprivileged-scratch-only.ru.md)
