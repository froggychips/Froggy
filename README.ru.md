...
приложения, чтобы освободить unified memory. Создан для 8 GB — актуален
везде, где LLM-инференс конкурирует с другими приложениями за RAM.
...
📖 [THESIS](docs/THESIS.md) · [POSITIONING](docs/POSITIONING.md) · [FAQ](docs/FAQ.md) · [ADR'ы](docs/adr/) · [Plugin guide](docs/PLUGIN_GUIDE.ru.md) · [Экосистема](docs/ECOSYSTEM.ru.md) · [Packaging](packaging/README.md)
...
или *«резюмируй последний созвон»* — и Froggy ответит из локального контекста без copy-paste.
